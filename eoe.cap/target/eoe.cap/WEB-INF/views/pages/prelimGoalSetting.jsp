		...
		<div class="form-group row">
			...
			<div class="col-sm-12">
				<table class="table white-background">
								...
								<c:forEach items="${assessmentInfo.goalPlanInfo.elements}"
									...
									<tr>
										<td style="border: initial; text-align: initial;"><form:checkbox label="${assessmentInfo.goalPlanInfo.elements.get(elementStatus.index).desc}"
												path="goalPlanInfo.elements[${elementStatus.index}].selected"
												 />
											</td>
										<td style="border: initial; text-align: initial;"><form:checkbox label="${assessmentInfo.goalPlanInfo.elements.get(elementStatus.index+1).desc}"
												path="goalPlanInfo.elements[${(elementStatus.index+1)}].selected"
												 />
											</td>
										<td style="border: initial; text-align: initial;"><form:checkbox label="${assessmentInfo.goalPlanInfo.elements.get(elementStatus.index+2).desc}"
												path="goalPlanInfo.elements[${(elementStatus.index+2)}].selected"
												 />
											</td>
					...
					<tr>
						<td><form:textarea path="goalPlanInfo.importance"
					...
					<tr>
						<td colspan="2">
							<table class="table">
								...
								<tr>
									<td style="border: none"><form:textarea
			...
			<div class="col-sm-12">
				<table class="table white-background" style="table-layout: auto;">
					...
					<tr>
						...
						<td><form:textarea path="goalPlanInfo.skillsAcquired"
								cssClass="form-control" maxLength="4000" rows="5" />
					...
					<tr>
						...
						<td><form:textarea path="goalPlanInfo.successEval"
								cssClass="form-control" maxLength="4000" rows="5" />
					...
					<tr>
						...
						<td><form:textarea path="goalPlanInfo.progressMeasure"
								cssClass="form-control" maxLength="4000" rows="5" />
					...
					<tr>
						...
						<td><form:textarea path="goalPlanInfo.realisticMeasure"
								cssClass="form-control" maxLength="4000" rows="5" />
					...
					<tr>
						...
						<td><form:textarea path="goalPlanInfo.achievementTime"
								cssClass="form-control" maxLength="4000" rows="5" />
