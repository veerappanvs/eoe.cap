	...
	<table id="supervisorResult" class="table table-hover table-bordered table-striped"> 
		...
		<tbody>
			<c:forEach items="${supervisors}" var="supervisor">			
				<tr>
					<td><a href="#"  onclick="assignSupervisor('<spring:escapeBody javaScriptEscape="true" >${supervisor.name}</spring:escapeBody>','${supervisor.daPersonId}')" >${supervisor.name}</a></td>
