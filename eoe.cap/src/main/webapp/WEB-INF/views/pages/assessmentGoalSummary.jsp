...
<script>
	...
	<form:form id="form2" method="POST" commandName="assessmentInfo"  >
		...
		<sec:authorize
			access="hasAnyRole('ROLE_SUPERVISOR','ROLE_PRACTITIONER','ROLE_MANAGER')">
			<div class="form-group row">
				<div class="col-sm-12">
					<table class="table">
						<tr>
						...
						<tr>
							<td><form:textarea path="goalPlanInfo.feedback"
									readonly="${!displayEdit}" cssClass="form-control"
									maxLength="4000" rows="5" aria-label="Feedback from Program Supervisor/Supervising Practitioner"/></td>
						</tr>
		...
		<sec:authorize access="hasAnyRole('ROLE_CANDIDATE')">
			<div class="form-group row">
				<div class="col-sm-12">
					<table class="table">
						<tr>
		...
		<c:if test="${displayEdit}">
			<sec:authorize access="hasAnyRole('ROLE_CANDIDATE')">
				<c:if test="${assessmentInfo.enableCompletion}">
					<div class="form-group row">
						<div class="col-sm-5"></div>
						<div class="col-sm-2">
							<form:checkbox path="completeSelfAssessment" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-10"><b>Note:</b> Please check this box if this Self-Assessment is complete.  This will give the Evaluation Team
							access to this Form.</div>
						<div class="col-sm-1"></div>
					</div>
				</c:if>

				<c:if test="${!(assessmentInfo.completed eq 'Y')}">
					<div class="form-group row">
						<div class="col-sm-4"></div>
						<div class="col-sm-4"></div>
						<div class="col-sm-4">
							<div style="margin: 10px">
								<input type="submit" value="Back" name="command"
									...
									value="Save" name="command" class="btn btn-primary" /> <input
					...
					<div class="col-sm-4">
						<div style="margin: 10px">
							<input type="submit" value="Save" name="command"
								...
								value="Return for edits" name="command" class="btn btn-primary" />
							<input type="hidden" value="2" name="prev" /> <input
								type="hidden" value="2" name="curr" /> <input type="hidden"
								value="2" name="nxt" />
						</div>
					</div>
				</div>
