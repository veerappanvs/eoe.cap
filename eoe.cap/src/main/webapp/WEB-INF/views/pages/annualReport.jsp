	...
	<form:form id="form1"  method="POST" commandName="cycleReportInfo" action="/cap/reports/getReport">
		<sec:authorize access="hasRole('ROLE_ADMIN')">
			<div class="form-group row">
				...
				<div class="col-sm-2">
					<div class="col-form-label float-right font-weight-bold">Select CAP Completion School Year:</div>
				</div>
				<div class="col-sm-2">
					<form:select id="selectSchoolYear" path="selectSchoolYear"
						class="form-control custom-select-lg" aria-label="Please Select CAP Completion School Year">
